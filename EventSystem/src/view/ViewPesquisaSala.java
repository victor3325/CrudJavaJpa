 ...
 * @author victo
 */
public class ViewPesquisaSala extends javax.swing.JFrame {

    /**
     * Creates new form ConsultaAlunoId
     */
    public ViewPesquisaSala() {
        initComponents();
    ...
    public void PopularJTable(int idAluno, int idSala, int idEtapa) {
        ...
        DefaultTableModel model =(DefaultTableModel) tblTurma.getModel();
                ...
                List<AlunosEntity> alunos = new AlunosRep().listarPorSala(idAluno, idSala, idEtapa);
    ...
    private void btnTurmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTurmaActionPerformed
        ...
        ArrayList<IdCompostoAlunoEtapaSala> listaidSala = new AlunoEtapaSalaRep().listarPorIdSalaComposto(idSala,idEtapa);
        
        for (int i = 0; i < listaidSala.size(); i++) {
            alunos.setIdAluno(listaidSala.get(i).getIdAluno());
            listaidSala.get(i).getIdSala();
            listaidSala.get(i).getIdEtapa();
            PopularJTable(listaidSala.get(i).getIdAluno(), idSala, idEtapa);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPesquisaSala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPesquisaSala().setVisible(true);
            }
        });
    }

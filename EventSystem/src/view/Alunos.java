 ...
 */
@Entity
@Table(name = "alunos", catalog = "mydb", schema = "")
@NamedQueries({
    ...
    , @NamedQuery(name = "Alunos.findByIdEspaco", query = "SELECT a FROM Alunos a WHERE a.idEspaco = :idEspaco")
    , @NamedQuery(name = "Alunos.findByIdSala", query = "SELECT a FROM Alunos a WHERE a.idSala = :idSala")})
